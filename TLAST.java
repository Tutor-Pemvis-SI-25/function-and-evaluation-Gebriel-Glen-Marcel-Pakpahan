...
public class TLAST {
    ...
    public static void addTask(String[] descriptions, String[] codes, String[] courses, String[] lecturers, String[] deadlines, String[] filenames, int[] difficulties, int[] days, String[] statuses, double[] priorities, int count) {
    ...
    public static void updateTask(String[] codes, String[] statuses, int count) {
        String targetCode, newStatus;
        int i;

        targetCode = input.nextLine();
        newStatus = input.nextLine();
        for (i = 0; i <= count - 1; i++) {
            if (codes[i].equals(targetCode)) {
